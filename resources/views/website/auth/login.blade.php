...
<html lang="en">
                    ...
                    <div class="col-lg-12">
                        <div class="registration-wrapper-1">
                            <div class="logo-area mb--0">
                                <img
                                    class="mb--10"
                                    src="assets/images/logo/fav.html"
                                    alt="logo"
                                />
                            </div>
    ...
    <div class="another-way-to-registration">
        ...
        <div class="login-with-brand">
            ...
            <a href="#" class="single">
                <img
                    src="assets/images/form/google.html"
                    alt="login"
                />
            </a>
            ...
            <a href="#" class="single">
                <img
                    src="assets/images/form/facebook.html"
                    alt="login"
                />
            </a>
                    ...
                    <div class="col-lg-12">
                        ...
                        <div class="social-and-payment-area-wrapper">
                            ...
                            <div class="payment-access">
                                ...
                                <img
                                    src="assets/images/payment/01.html"
                                    alt=""
                                />
                            </div>
                        </div>
                    ...
                    <div class="col-lg-12">
                        <div class="copyright-between-1">
                            ...
                            <a href="#" class="playstore-app-area">
                                ...
                                <img
                                    src="assets/images/payment/02.html"
                                    alt=""
                                />
                                <img
                                    src="assets/images/payment/03.html"
                                    alt=""
                                />
                            </a>
                        </div>
                    ...
                    <div class="details-product-area">
                        <div class="product-thumb-area">
                            ...
                            <div class="thumb-wrapper one filterd-items figure">
                                ...
                                >
                                    <img
                                        src="assets/images/products/product-details.html"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            <div class="thumb-wrapper two filterd-items hide">
                                ...
                                >
                                    <img
                                        src="assets/images/products/product-filt2.html"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            <div class="thumb-wrapper three filterd-items hide">
                                ...
                                >
                                    <img
                                        src="assets/images/products/product-filt3.html"
                                        alt="product-thumb"
                                    />
                                </div>
                            </div>
                            <div class="product-thumb-filter-group">
                                <div
                                    class="thumb-filter filter-btn active"
                                    data-show=".one"
                                >
                                    <img
                                        src="assets/images/products/product-filt1.html"
                                        alt="product-thumb-filter"
                                    />
                                </div>
                                <div
                                    class="thumb-filter filter-btn"
                                    data-show=".two"
                                >
                                    <img
                                        src="assets/images/products/product-filt2.html"
                        ...
                        <div class="contents">
                            ...
                            <div class="product-uniques">
                                <span class="sku product-unipue"
                                    ><span>SKU: </span> BO1D0MX8SJ</span
                                >
                                <span class="catagorys product-unipue"
                                    ><span>Categories: </span> T-Shirts, Tops,
                                    Mens</span
                                >
                                <span class="tags product-unipue"
                                    ><span>Tags: </span> fashion, t-shirts,
                                    Men</span
                                >
                            </div>
        ...
        <!-- Modal -->
        <div
            class="modal modal-compare-area-start fade"
            id="exampleModal"
            tabindex="-1"
                    ...
                    <div class="modal-body">
                        <div class="compare-main-wrapper-body">
                            ...
                            <div class="single-compare-elements">
                                <div class="thumbnail-preview">
                                    <img
                                        src="assets/images/grocery/02.jpg"
                                        alt="grocery"
                                    />
                                </div>
                            </div>
                            <div class="single-compare-elements">
                                <div class="thumbnail-preview">
                                    <img
                                        src="assets/images/grocery/03.jpg"
                                        alt="grocery"
                                    />
                                </div>
                            </div>
                        ...
                        <div
                            class="compare-main-wrapper-body productname spacifiq"
                        >
